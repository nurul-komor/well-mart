        ...
        <div class="flex-none w-full max-w-full px-3">
            ...
            <div
                ...
                <div
                    ...
                    <div>
                        <a class="py-2 px-3 text-white rounded bg-blue-500" href="{{ route('admin.news.create') }}">
                            Add news</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a href="{{ asset($item->image) }}">
                                                <img src="{{ asset($item->image) }}" class="rounded max-w-[200px]"
                                                    alt="">
                                            </a>
                                        <td
                                            class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                        ...
                                        <td
                                            ...
                                            <form
                                                action="{{ route('admin.news.destroy', [
                                                    'news' => $item->id,
                                                ]) }}"
                                                method="post">
                                                @csrf
