    ...
    <div class="items-center block w-auto max-h-screen min-h-screen overflow-auto  grow basis-full" id="sidebar">
        ...
        <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full">
                <a class="py-2.7 {{ Route::is('admin.dashboard') == true ? 'bg-blue-500/13 font-semibold' : '' }} text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap rounded-lg px-4  text-slate-700 transition-colors "
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.orders.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.contact.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.customer.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.delivery_men.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.seller.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.product_categories.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.products.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.news_category.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ Route::is('admin.news.index') == true ? 'bg-blue-500/13 font-semibold' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors rounded-lg"
