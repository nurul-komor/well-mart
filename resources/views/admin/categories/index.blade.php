                ...
                <div
                    ...
                    <div>
                        <a class="py-2 px-3 text-white rounded bg-blue-500"
                            href="{{ route('admin.product_categories.create') }}">Create Categroy</a>
                    </div>
                                ...
                                @foreach ($categories as $category)
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a href="{{ route('admin.product_categories.edit', ['product_category' => $category->id]) }}"
                                                class="text-blue-400 mr-1 underline">Edit</a>
                                            <form
                                                action="{{ route('admin.product_categories.destroy', [
