                ...
                <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex justify-between">
                    ...
                    <div>
                        <a class="py-2 px-3 text-white rounded bg-blue-500"
                            href="{{ route('admin.product_categories.index') }}">Edit Category</a>
                    </div>
                </div>
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-3 overflow-x-auto ">
                        <form action="{{ route('admin.product_categories.update', ['product_category' => $category->id]) }}"
                                    ...
                                    <div class="w-72 mb-2">
                                        <div class="relative h-10 w-full min-w-[200px]">
                                            <input
                                                ...
                                                placeholder=" " name="categoryName" value="{{ $category->categoryName }}" />
