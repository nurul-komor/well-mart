...
class SslCommerzPaymentController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($orders != null) {
            $latestId = $orders->id + 1;
        }
        $invoice = time() . str_pad($latestId + 1, 5, 0, STR_PAD_LEFT);
        ...
        if ($request->payment == "cash-on-delivery") {
            ...
            OrderPlacedJob::dispatch(auth()->user());
        ...
        } else if ($request->payment == "online-payment") {
    ...
    public function success(Request $request)
    {
        ...
        if ($order_details->status == 'Pending') {
             ...
             */
            echo "Transaction is successfully Completed  and order is placed successfully";
