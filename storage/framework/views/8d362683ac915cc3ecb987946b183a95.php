                ...
                <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex justify-between">
                    ...
                    <div>
                        <a class="py-2 px-3 text-white rounded bg-blue-500"
                            href="<?php echo e(route('admin.product_categories.index')); ?>">Edit Category</a>
                    </div>
                </div>
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-3 overflow-x-auto ">
                        <form action="<?php echo e(route('admin.product_categories.update', ['product_category' => $category->id])); ?>"
                                    ...
                                    <div class="w-72 mb-2">
                                        <div class="relative h-10 w-full min-w-[200px]">
                                            <input
                                                ...
                                                placeholder=" " name="categoryName" value="<?php echo e($category->categoryName); ?>" />
...
unset($__errorArgs, $__bag); ?>
                                    ...
                                    <div class="w-72 mb-3">
                                        ...
                                        <input type="file" name="profileImage" id="profileImage" class="hidden">
                                        ...
                                        <div class="inline-flex items-center">
                                            <div class="relative inline-block h-4 w-8 cursor-pointer rounded-full">
                                                <input id="switch-3" type="checkbox" name="status"
                                                    ...
                                                    <?php if($category->status == 1): ?> <?php echo e('checked'); ?> <?php endif; ?> />
                                                <label for="switch-3"
...
<?php echo $__env->make('admin.layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>