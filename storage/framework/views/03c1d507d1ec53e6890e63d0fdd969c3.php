<?php $__env->startSection('main'); ?>
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('common.cart.add')); ?>" method="post">
            ...
            <div class="basis-full p-4 md:max-w-[1200px] bg-white mx-auto">
                <div class="flex flex-col items-center md:items-start md:flex-row">
                    <div class="basis-full md:basis-[40%] lg:basis-[50%] h-[70vh]">
                        ...
                        <div class="owl-carousel product-modal max-w-[auto]  md:max-w-[300px] lg:max-w-[400px]  ">
                            <div class="item mb-5  cursor-grab ">
                                <img src="<?php echo e(asset($product->productImage)); ?>" class="object-contain max-h-[600px]"
                                    alt="product image">
                            </div>
                            <?php if($product->productImage2 != ''): ?>
                                <div class="item mb-5  cursor-grab ">
                                    <img src="<?php echo e(asset($product->productImage2)); ?>" class="object-contain max-h-[600px]"
                                        alt="product image">
                                </div>
                            <?php endif; ?>
                        </div>
                    ...
                    <div class="basis-full md:basis-[60%] lg:basis-[50%] font-montserrat p-4 md:p-0">
                        <h3 class=""><?php echo e($product->productName); ?></h3>

                        <h4 class="  mt-3 mb-2 inline-block">BDT
                            <?php echo e($product->discount == null || $product->discount < 1 ? $product->price : ($product->price * (100 - $product->discount)) / 100); ?>

                        </h4>
                        <?php if($product->discount == null || $product->discount > 0): ?>
                            <h6><span class="text-red-500 line-through mb-2">BDT <?php echo e($product->price); ?></span></h6>
                        <?php endif; ?>
                        ...
                        <?php if(json_decode($product->colors) != null): ?>
                            ...
                            <ul class="flex w-full optionList gap-3">
                                <?php $__currentLoopData = json_decode($product->colors); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $color): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="">
                                        <label for="color-<?php echo e($num); ?>"
                                            class="cursor-pointer flex flex-col items-center justify-center">
                                            <p><span
                                                    style="background: <?php echo e($color); ?>;padding:5px;border-radius:50%;width:20px;height:20px;display:inline-block;margin-right:5px;"></span>
                                            </p>
                                            <input type="radio" name="color" id="color-<?php echo e($num); ?>"
                                                class="hidden" value="<?php echo e($color); ?>">
                                        </label>
                        ...
                        <?php if(json_decode($product->options) != null): ?>
                            ...
                            <ul class="flex w-full gap-3 space-x-2 py-2 border-b border-gray-200 optionList">
                                ...
                                <?php $__currentLoopData = json_decode($product->options); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $option): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <li class="">
                                        <label for="option-<?php echo e($num2); ?>">
                                            <p
                                                class="px-2 py-1 rounded-sm mr-2 ring-1 ring-slate-400 inline-block cursor-pointer ">
                                                <?php echo e($option); ?> </p>
                                        </label>
                                        <input value="<?php echo e($option); ?>" type="radio" name="option"
                                            id="option-<?php echo e($num2); ?>" class="hidden">
                        ...
                        <?php if($product->quantity < 6): ?>
                            <p class="text-gray-600 text-sm">
                                Only <?php echo e($product->quantity); ?> items left
                            </p>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <div class="grid gird-flow-rows grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5"
            ...
            <?php $__currentLoopData = $relatedProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                <a class="product-item relative p-4 lg:p-6 flex flex-col items-center "
                    href="/products/singleProduct/<?php echo e($item->product_code); ?>">
                    <div class="h-[200px] inline-block w-full cursor-zoom-in  bg-cover   bg-center duration-125">
                        <img src="<?php echo e(asset($item->productImage)); ?>" class="max-h-[200px] w-full object-contain"
                            alt="" loading="lazy">

                    </div>
                    <div class="label flex flex-col items-center">
                        <small
                            class="font-montserrat text-gray-700 text-xs font-medium"><?php echo e($item->getCategory->categoryName); ?></small>
                        <label for="product-modal" class="cursor-pointer">
                            <b class="text-sm py-2 hover:text-commonPrimary text-limit"><?php echo e($item->productName); ?></b>
                        </label>
...
<?php echo $__env->make('common.components.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/common/single_product.blade.php ENDPATH**/ ?>