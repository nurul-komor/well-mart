        ...
        <div class="flex-none w-full max-w-full px-3">
            ...
            <div
                ...
                <div
                    ...
                    <h6 class="dark:text-white">item table</h6>

                    <div>
                        <a class="py-2 px-3 text-white rounded bg-blue-500" href="<?php echo e(route('admin.news.create')); ?>">
                            Add news</a>
                    </div>
                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a href="<?php echo e(asset($item->image)); ?>">
                                                <img src="<?php echo e(asset($item->image)); ?>" class="rounded max-w-[200px]"
                                                    alt="">
                                            </a>
                                        <td
                                            class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                        ...
                                        <td
                                            class="p-2 align-middle bg-transparent border-b dark:border-white/40 whitespace-nowrap shadow-transparent">
                                            <?php if(json_decode($item->tags) != null): ?>
                                                <?php $__currentLoopData = json_decode($item->tags); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <p class="p-1 ring-1 text-center inline-block rounded-sm">
                                                        <?php echo e($tag); ?>
                                        ...
                                        <td
                                            ...
                                            <a href="<?php echo e(route('admin.news.edit', ['news' => $item->id])); ?>"
                                                class="text-blue-400 mr-1 underline">Edit</a>
                                            <form
                                                action="<?php echo e(route('admin.news.destroy', [
                                                    'news' => $item->id,
                                                ])); ?>"
                                                method="post">
                                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/admin/news/index.blade.php ENDPATH**/ ?>