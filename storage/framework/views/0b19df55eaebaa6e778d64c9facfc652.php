                ...
                <div
                    ...
                    <div>
                        <a class="py-2 px-3 text-white rounded bg-blue-500"
                            href="<?php echo e(route('admin.product_categories.create')); ?>">Create Categroy</a>
                    </div>
                                ...
                                <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <a href="<?php echo e(route('admin.product_categories.edit', ['product_category' => $category->id])); ?>"
                                                class="text-blue-400 mr-1 underline">Edit</a>
                                            <form
                                                action="<?php echo e(route('admin.product_categories.destroy', [
                                                ...
                                                <button class="text-blue-400 mr-1 underline"
                                                    onclick="return confirm('Do you want do delete this category?')">Delete</button>
                                            </form>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/admin/categories/index.blade.php ENDPATH**/ ?>