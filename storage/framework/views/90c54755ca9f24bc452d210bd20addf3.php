                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex px-2 py-1">
                                                <div>
                                                    <a href="<?php echo e(asset($seller->image)); ?>" class="cursor-pointer">

                                                        <img src=" <?php echo e($seller->image != null ? asset($seller->image) : 'https://ui-avatars.com/api/?name=' . $seller->name); ?>
                                        ...
                                        <td
                                            ...
                                            <a class="text-blue-400 mr-1 underline"
                                                href="<?php echo e(route('admin.seller.delete', ['sellers' => $seller->id])); ?>">Delete</a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ljyvglni/multiple-vendor.nurulkomor.xyz/resources/views/admin/sellers/index.blade.php ENDPATH**/ ?>