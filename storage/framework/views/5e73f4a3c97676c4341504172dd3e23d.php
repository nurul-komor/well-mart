    ...
    <div fixed-plugin-card
        ...
        <div class="px-6 pt-4 pb-0 mb-0 border-b-0 rounded-t-2xl">
            <div class="float-left">
                <h5 class="mt-4 mb-0 dark:text-white"><?php echo e(config('app.name')); ?></h5>
                <p class="dark:text-white dark:opacity-80">Customize options.</p>
            </div>
...
<?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/admin/layouts/right-sidebar.blade.php ENDPATH**/ ?>