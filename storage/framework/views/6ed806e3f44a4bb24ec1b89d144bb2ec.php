                                    ...
                                    <tr>
                                        ...
                                        <td
                                            ...
                                            <div class="flex px-2 py-1">
                                                <div>
                                                    <img src=" <?php echo e($customer->image != null ? asset($customer->image) : 'https://ui-avatars.com/api/?name=' . $customer->name); ?>
                                        ...
                                        <td
                                            ...
                                            <a class="text-blue-400 mr-1 underline"
                                                href="<?php echo e(route('admin.customer.delete', ['customer' => $customer->id])); ?>">Delete</a>
                                        </td>
...
<?php echo $__env->make('admin.layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ljyvglni/multiple-vendor.nurulkomor.xyz/resources/views/admin/customers/index.blade.php ENDPATH**/ ?>