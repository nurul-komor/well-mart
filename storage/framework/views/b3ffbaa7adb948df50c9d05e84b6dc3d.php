...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('delivery_men.login')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('password.request')): ?>
                    <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800 mx-2"
...
<?php endif; ?>
<?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/delivery_men/auth/login.blade.php ENDPATH**/ ?>