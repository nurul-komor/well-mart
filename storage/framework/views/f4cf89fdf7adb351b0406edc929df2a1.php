                ...
                <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent flex justify-between">
                    ...
                    <div>
                        <a class="py-2 px-3 text-white rounded bg-blue-500"
                            href="<?php echo e(route('admin.news_category.index')); ?>">Edit Category</a>
                    </div>
                </div>
                <div class="flex-auto px-0 pt-0 pb-2">
                    <div class="p-3 overflow-x-auto ">
                        <form action="<?php echo e(route('admin.news_category.update', ['news_category' => $category->id])); ?>"
                                    ...
                                    <div class="w-72 mb-2">
                                        <div class="relative h-10 w-full min-w-[200px]">
                                            <input
                                                ...
                                                placeholder=" " name="name" value="<?php echo e($category->name); ?>" />
...
<?php echo $__env->make('admin.layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/admin/news_category/edit.blade.php ENDPATH**/ ?>