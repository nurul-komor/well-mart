        ...
        <div class="w-full max-w-full px-3 lg:w-5/12 lg:flex-none">
            <div slider class="relative w-full h-full overflow-hidden rounded-2xl">
                ...
                <div slide class="absolute w-full h-full transition-all duration-500">
                    <img class="object-cover h-full" src="<?php echo e(asset('admin/assets/img/carousel-1.jpg')); ?>"
                        alt="carousel image" />
                    <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                        ...
                        <p class="">There’s nothing I really wanted to do in life that I wasn’t able to
                            get good at.</p>
                    </div>
                </div>
                ...
                <div slide class="absolute w-full h-full transition-all duration-500">
                    ...
                    <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                        ...
                        <p class="">That’s my skill. I’m not really specifically talented at anything
                ...
                <div slide class="absolute w-full h-full transition-all duration-500">
                    ...
                    <div class="block text-start ml-12 left-0 bottom-0 absolute right-[15%] pt-5 pb-5 text-white">
                        ...
                        <p class="">Don’t be afraid to be wrong because you can’t learn anything from a
                            compliment.</p>
                    </div>
                </div>
                    ...
                    <ul class="flex flex-col pl-0 mb-0 rounded-lg">
                        ...
                        <li class="relative flex justify-between py-2 pr-4 mb-2 border-0 rounded-xl text-inherit">
                            <div class="flex items-center">
                                ...
                                <div class="flex flex-col">
                                    ...
                                    <span class="text-xs leading-tight">123 closed, <span
                        ...
                        <li
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex flex-col">
                                    <h6 class="mb-1 text-sm leading-normal text-slate-700">Error logs
                                    </h6>
                                    <span class="text-xs leading-tight">1 is active, <span
                        ...
                        <li class="relative flex justify-between py-2 pr-4 border-0 rounded-b-lg rounded-xl text-inherit">
                            <div class="flex items-center">
                                ...
                                <div class="flex flex-col">
                                    <h6 class="mb-1 text-sm leading-normal text-slate-700">Happy users
                                    </h6>
                                    <span class="text-xs leading-tight"><span class="font-semibold">+
                                            430 </span></span>
                                </div>
                            </div>
                            <div class="flex">
...
<?php $__env->startPush('outletjs'); ?>
    ...
    <script src="<?php echo e(asset('admin/assets/js/carousel.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/assets/js/plugins/Chart.extension.js')); ?>"></script>
    <script src="<?php echo e(asset('admin/assets/js/plugins/chartjs.min.js')); ?>" async></script>
    <script src="<?php echo e(asset('admin/assets/js/charts.js')); ?>"></script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('admin.layouts.app-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/komor/Documents/personal/well-mart/resources/views/admin/dashboard.blade.php ENDPATH**/ ?>