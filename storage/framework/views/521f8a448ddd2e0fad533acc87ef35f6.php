...
<?php endif; ?>
        ...
        <form method="POST" action="<?php echo e(route('seller.login')); ?>">
            <?php echo csrf_field(); ?>
...
<?php endif; ?>
            ...
            <div class="flex items-center justify-end mt-4">
                <?php if(Route::has('seller.password.request')): ?>
                    <a class="underline text-sm text-gray-600 dark:text-gray-400 hover:text-gray-900 dark:hover:text-gray-100 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 dark:focus:ring-offset-gray-800"
                        href="<?php echo e(route('seller.password.request')); ?>">
...
<?php endif; ?>
<?php /**PATH /home/ljyvglni/multiple-vendor.nurulkomor.xyz/resources/views/seller/auth/login.blade.php ENDPATH**/ ?>