            ...
            <div class="basis-full lg:basis-[65%]">
                ...
                <div class="flex flex-col gap-y-4 mb-4">
                    <div class="image  ring-gray-200 w-full h-120">
                        <img src="<?php echo e(asset($news->image)); ?>" class="object-cover h-120 w-full" alt="new image">
                    </div>
                    <ul class="flex text-xs gap-3 items-center">
                        <li class="text-red-400"><?php echo e($news->getCategory->name); ?></li>
                        <li class="select-none">.</li>
                        <li><?php echo e(date('M d, Y')); ?></li>
                        <li class="select-none">.</li>
                        <li><span class="text-gray-400">by</span> admin</li>
                    </ul>
                    <h1 class="text-xl font-bold hover:text-red-500 duration-150"><?php echo e($news->title); ?></h1>
                    <p class="text-sm font-medium text-slate-500  inline-block"><?php echo $news->content; ?></p>


                </div>

            </div>
            <div class="basis-[35%] pl-8 py-4 hidden lg:block">
...
<?php echo $__env->make('common.components.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/common/news/single_news.blade.php ENDPATH**/ ?>