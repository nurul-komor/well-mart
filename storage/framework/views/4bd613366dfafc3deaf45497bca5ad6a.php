        ...
        <nav>
            ...
            <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                ...
                <li class="text-sm pl-2 capitalize leading-normal text-white before:float-left before:pr-2 before:text-white before:content-['/']"
                    aria-current="page"><?php echo e($pageTitle ?? ''); ?></li>
            </ol>
            <h6 class="mb-0 font-bold text-white capitalize"><?php echo e($pageTitle ?? ''); ?></h6>
        </nav>
                        ...
                        <?php $__currentLoopData = auth()->guard('admin')->user()->unreadNotifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li class="relative mb-2">
                                <a class="dark:hover:bg-slate-900 ease py-1.2 clear-both block w-full whitespace-nowrap rounded-lg bg-transparent px-4 duration-300 hover:bg-gray-200 hover:text-slate-700 lg:transition-colors"
                                    href="<?php echo e(route('notification.asRead', [
                                        'id' => $notification->id,
                                    ...
                                    <div class="flex py-1">
                                        ...
                                        <div class="flex flex-col justify-center">
                                            <h6 class="mb-1 text-sm font-medium leading-normal dark:text-white  ">
                                                <?php echo e($notification['data']['message']); ?></h6>
                                            <p class="mb-0 text-xs leading-tight text-slate-400 dark:text-white/80">
                                                <i class="mr-1 fa fa-clock"></i>
                                                <?php echo e(getDiff($notification['created_at'])); ?>
...
<?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/admin/layouts/navbar.blade.php ENDPATH**/ ?>