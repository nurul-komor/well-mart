...
<?php if (isset($attributes)) { $__attributesOriginal976d5c6377dcf4a1faf49ff9b4ac5035 = $attributes; } ?>
                                    ...
                                    <div class="relative mb-4">
                                        ...
                                        <select id="category"
                                            ...
                                            <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e(__($category->id)); ?>">
...
<?php endif; ?>
                                    ...
                                    <div class="relative mb-4">
                                        ...
                                        <?php if (isset($component)) { $__componentOriginalf94ed9c5393ef72725d159fe01139746 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalf94ed9c5393ef72725d159fe01139746 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input-error','data' => ['messages' => $errors->get('vrImage'),'class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
<?php $component->withName('input-error'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag && $constructor = (new ReflectionClass(Illuminate\View\AnonymousComponent::class))->getConstructor()): ?>
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['messages' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($errors->get('vrImage')),'class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginalf94ed9c5393ef72725d159fe01139746)): ?>
<?php $attributes = $__attributesOriginalf94ed9c5393ef72725d159fe01139746; ?>
...
<?php endif; ?>
                                    ...
                                    <div class="relative mb-4">
                                        ...
                                        <input id="product-brand"
                                            class="peer h-full w-full border-2 py-2 px-2 mt-1 rounded-md focus:ring-2 ring-slate-500 outline-none  placeholder:text-sm"
                                            placeholder="eg: Bata" name="brand" value="<?php echo e(old('brand')); ?>" />
                                ...
                                <div class="basis-full md:basis-[50%] px-4">
                                    <div class="relative mb-4">
                                        ...
                                        <input id="product-price"
                                            ...
                                            value="<?php echo e(old('productPrice')); ?>" />
...
<?php endif; ?>
                                    ...
                                    <div class="relative mb-4">
                                        ...
                                        <input id="discount"
                                            ...
                                            max="100" value="<?php echo e(old('discount')); ?>" />
                            ...
                            <div class="px-4">
                                <div class="relative mb-4">
                                    ...
                                    <textarea
                                        ...
                                        placeholder="type about this product" name="description" id="description" rows="12"><?php echo e(old('description')); ?></textarea>
...
<?php endif; ?>
 ...
 <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal976d5c6377dcf4a1faf49ff9b4ac5035)): ?>
<?php $attributes = $__attributesOriginal976d5c6377dcf4a1faf49ff9b4ac5035; ?>
<?php unset($__attributesOriginal976d5c6377dcf4a1faf49ff9b4ac5035); ?>
<?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /home/ljyvglni/multiple-vendor.nurulkomor.xyz/resources/views/seller/products/create.blade.php ENDPATH**/ ?>