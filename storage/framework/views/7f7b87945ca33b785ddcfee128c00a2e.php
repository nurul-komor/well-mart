         ...
         <div class="flex items-center gap-2 pt-2  right-0 pr-5">
             ...
             <a href="<?php echo e(route('cart.index')); ?>" class="text-3xl font-bold px-2 hover:text-commonPrimary duration-75">
                 <div class="relative">
                     ...
                     <small
                         class="top-0 left-5 absolute  px-1 bg-green-400 border-2 border-white dark:border-gray-800 rounded-full text-xs text-white font-poppins"><?php echo e(collect(session('cart'))->count()); ?></small>
                 </div>
             </a>
 ...
 <?php $__env->stopPush(); ?>
<?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/common/components/navbar.blade.php ENDPATH**/ ?>