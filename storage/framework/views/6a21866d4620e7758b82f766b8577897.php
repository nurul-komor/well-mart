<div class="rounded-lg w-full h-screen bg-[#17151563] fixed left-0 top-0 z-[2000] flex items-center justify-center "
    ...
    <div class="bg-white p-10 rounded-lg w-[500px] min-h-[400px] text-center">
        ...
        <form action="<?php echo e(route('admin.products.changeStatus')); ?>" method="post">
            <?php echo csrf_field(); ?>
            <label for="statusChanger"
                class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Select an
                status</label>
            ...
            <div class="reason-box hidden">
                ...
                <label for="reason"
                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white text-left">Reason</label>
            ...
            <div class="flex gap-5 flex-wrap  mt-3 justify-end">
                <button type="button"
                    class="text-red-700 hover:text-white border border-red-600 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 mb-2 dark:border-red-500 dark:text-red-500 dark:hover:text-white dark:hover:bg-red-600 dark:focus:ring-red-900"
...
<?php /**PATH /media/komor/volume 2/projects/others/institute-project/resources/views/admin/products/modal.blade.php ENDPATH**/ ?>